const LoginLeftSide = () => {
  return (
    <div className="hidden md:flex w-1/2  bg-linear-to-br from-slate-950 via-purple-800 to-fuchsia-900 relative overflow-hidden border-r border-slate-200">
      <div className="absolute -top-30 -left-30 w-72 h-72 bg-fuchsia-500/20 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full">
        ...
        <p className=" text-fuchsia-200 text-lg max-w-md leading-relaxed">
