          ...
          animate-fade-in' onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                    ...
                    <div>
                        ...
                        <textarea name="reason" id='reason' required rows={3} className='resize-none'
                    ...
                    <div className='flex gap-3 pt-2'>
                        ...
                        <button type='button' className='bg-linear-to-br from-purple-700 to-fuchsia-900 text-white
                         rounded-md hover:from-purple-800 hover:to-fuchsia-900 flex-1 flex items-center justify-center gap-2'
