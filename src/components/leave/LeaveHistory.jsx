                                            ...
                                            <td>
                                                {leave.status === "PENDING" && (
                                                    <div className=' flex justify-center gap-2'>
                                                        <button className='p-1.5 rounded-md bg-emerald-100 text-emerald-600 hover:bg-emerald-100 transition-colors'
                                                            onClick={() => handleStatusUpdate(leave.id || leave._id, "APPROVED")}
                                                            disabled={!!processing}>
                                                            {processing === (leave.id || leave._id) ? <Loader2Icon className='w-4 h-4 animate-spin' />
